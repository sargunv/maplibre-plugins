...
pub fn build(b: *std.Build) void {
    ...
    options.addOption([]const u8, "shade_glsl", readRepoFile(b, "../shaders/shore.glsl"));
    ...
    b.step("test", "Run the layout geometry and spec parity tests").dependOn(&b.addRunArtifact(tests).step);
}

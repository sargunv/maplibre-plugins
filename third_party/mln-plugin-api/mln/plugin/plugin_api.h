...
typedef struct mln_plugin_double2 {
    double x;
    double y;
} mln_plugin_double2;

/* Straight-alpha color. The host premultiplies registered defaults when it
 * adopts them into the style system. */
...
typedef union mln_plugin_value_data {
    ...
    mln_plugin_double2 double2_value;
 ...
 * per rendered frame per layer. The callback may run concurrently for different
